...
math_problems_2 = [
    ...
    },
    {
        ...
        "solution": r"\text{Celkové investičné náklady sú 5 mil. €, ktoré sú rozdelené podľa nasledujúcich percent: } \\[3mm] \text{rok 1: 10 \% = 0.10×5 mil. €} \\[3mm] \text{rok 2: 15\% = 0.15×5 mil. €} \\[3mm] \text{rok 3: 25\% = 0.25×5 mil. €} \\[3mm] \text{rok 4: 40\% = 0.40×5 mil. €} \\[3mm] \text{rok 5: 10 \% = 0.10×5 mil. €} \\[5mm] \textbf{Prepočítané (aktualizované) investičné náklady }\\[3mm] N_{ip} = \sum_{t=1}^{T_v}{N_{it} q^{T_v - T_{\Delta}-t}} \\[3mm] N_{ip} = \sum_{t=1}^{5}{N_{it}} * q^{5 - 1 - t} \\[3mm] N_{ip} = 5*0.1*1.05^{5-1-1} + 5*0.15*1.05^{5-2-1} + 5*0.25*1.05^{5-3-1} + 5*0.4*1.05^{5-4-1} + 5*0.1*1.05^{5-5-1}\\[3mm] N_{05} = 5* (0.1*1.05^{3} + 0.15*1.05^{2} + 0.25*1.05^{1} + 0.4*1.05^{0} + 0.1*1.05^{-1}) \\[3mm] N_{05} = ",
        "table": None,
