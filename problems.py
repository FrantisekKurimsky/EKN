...
math_problems_3 = [
    ...
    },
    {
        ...
        "solutiontable": {
            ...
            }).style.map(highlight_cols, subset=['súčasná hodnota CF 1', 'súčasná hodnota CF 2']).map(highlight_cols2, subset=['kumulované NPV 1', 'kumulované NPV 2', 'kumulované CF 1', 'kumulované CF 2'])
        }    
    },
    {
