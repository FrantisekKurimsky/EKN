...
math_problems_1 = [
    ...
    },
    {
        ...
        "solution": r"AHOJ \textbf{Zásobovateľ } \text{určuje súčasnú hodnotu n jednotkových pravidelných platieb koncom období.} \\[3mm] \text{Vypočíta sa ako súčet n členov geometrickej postupnosti.} \\[3mm] z_n = \sum_{t=1}^{n}{r^{-t}} = r^{-1} + r^{-2} + r^{-3} + \dots + r^{-n} \\[3mm] z_n = \frac{r^n-1}{r^n*(r-1)}\\[5mm] K_0 = \frac{r^{20} - 1}{r^{20} * (r-1)} * K \\[3mm] K_0 = \frac{1.02^{20}-1}{1.02^{20}*(1.02-1)*2500\\[3mm]K_0 = \frac{1.02^{20}-1}{1.02^{20}}*0.02}*2500" ,
        "table": None,
