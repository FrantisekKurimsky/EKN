...
math_problems_3 = [
    ...
    },
    {
        ...
        "solution": r"\text{Vzhľadom na to, že porovnávané varianty majú rovnakú ročnú tržbu aj} \\[3mm] \text{konštantné ročné prevádzkové náklady, možno použiť kritérium minimálnych aktualizovaných nákladov:}",
        "table": pd.DataFrame({
            "Variant": ["1", "2"],
            "N_ip (€)": ["6 mil.", "12,4 mil."],
            "N_vlr (€)": ["3,8 mil.", "3 mil."],
