...
math_problems_2 = [
    ...
    },
    {
        ...
        "solution": r"ahoj \text{Náklady na palivo : } \\[3mm] n_{pal} = Q_t * c_{pal} = 11.2 * 10^{-3} * 12 = 0.1344 €*kWh^{-1} \\[3mm] \text{ročná kvóta : }\\[3mm] k = \frac{1}{T_ž} + p_a + p_ú + p_{mz} + p{ost}, \tab p_a \thickapprox 0.03 \\[3mm] k = \frac{1}{30} + 0.03 + 0.04 = 0.103 \\[3mm] \text{merné náklady : } \\[3mm] n_v =(\frac{n_{st}}{\tau} + n_{pal}) * (1 + 0.1) \\[3mm] n_v = (\frac{k*N_i}{\tau} + n_{pal}) * 1.1 \\[3mm] n_v = (\frac{0.103 * 5100}{\tau} + 0.1344) *1.1 \\[3mm] n_{v1} = (\frac{525.3}{6000} + 0.1344) * 1.1  = 0.244145 €.kWh^{-1} \\[3mm] n_{v2} = (\frac{525.3}{4000} + 0.1344) * 1.1 0.2922975 €.kWh^{-1} //[3mm] n_{v1} < n{v2}",
        "table": None,
        "code": None,
        "solutiontable": None
    },
