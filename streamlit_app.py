...
math_problems_1 = [
    {
        ...
        "solution": r"\text{základ úrokovania: } i=\frac{p}{100}, \\[5mm] p: \text{percentová úroková miera a } i: \text{úroková sadzba,} \\[5mm] \text{začiatočná hodnota kapitálu (istiny) : } K_0, \\[5mm] \text{dĺžka úrokového obdobia : } n, \\[5mm] u=K_0⋅i⋅n \text{___________________} \\ \text{Jan, Feb, Mar, Apr, Maj, Jun, } \\ \text{30.Jun presne druhé švtrťročie, preto berieme do úvahy polovicu roka, a teda polovicu z 11% z 5000 €}",
        "table": None
    },
    {
