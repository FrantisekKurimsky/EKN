...
math_problems_1 = [
    ...
    },
    {
        ...
        "solution": r"\text{Začiatkom roka 2030 potrebujeme peniaze, teda postupne} \\[5mm] K_{2020-2029} = 3.8 * (1 + 0.06) ^ 9 \\[5mm] K_{2021-2029} = 4.1 * (1 + 0.06) ^ 8 \vdots K_{2028-2029} = 3.7 * (1 + 0.06) ^ 1",
        "code": None
    },
    {
