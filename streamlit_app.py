...
math_problems_1 = [
    {
        ...
        "solution": r"\text{základ úrokovania: } i=\frac{p}{100}, \\ p: \text{percentová úroková miera a } i: \text{úroková sadzba} \\[5mm] \text{začiatočná hodnota kapitálu (istiny) : } K_0 \\[5mm] \text{dĺžka úrokového obdobia : } n \\[5mm] u=K_0⋅i⋅n",
        "table": None
    },
    {
