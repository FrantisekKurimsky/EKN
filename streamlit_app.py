...
math_problems_1 = [
    {
        ...
        "solution": r"\text{základ úrokovania: } r=1+i=1+\frac{p}{100}, \\ p: \text{percentová úroková miera a } i: \text{úroková sadzba} \\[5mm] \text{začiatočná hodnota kapitálu (istiny) : } K_0 \\[5mm] u=K_0⋅i⋅n",
        "table": None
    },
    {
